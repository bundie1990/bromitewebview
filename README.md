...
The latest update should now work on all ROMs Android v7.0+. Any ROM Android v5.1+ should theoretically be compatible 
...
## [Changelog](https://github.com/Magisk-Modules-Repo/bromitewebview/blob/master/CHANGELOG.md)
